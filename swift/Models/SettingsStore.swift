...
final class SettingsStore: @unchecked Sendable {
    ...
    var loadTextureReplacements: Bool {
        didSet { iPSX2Bridge.setINIBool("EmuCore/GS", key: "LoadTextureReplacements", value: loadTextureReplacements) }
    }
    ...
    private init() {
        ...
        loadTextureReplacements = iPSX2Bridge.getINIBool("EmuCore/GS", key: "LoadTextureReplacements", defaultValue: false)
        // OSD
