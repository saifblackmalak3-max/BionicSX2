...
# -------------------------------------------------------------------------------
# iOS does not support OpenGL or traditional Vulkan — Metal only.
if(NOT APPLE AND NOT CMAKE_SYSTEM_NAME STREQUAL "iOS")
...
# -------------------------------------------------------------------------------
# Architecture detection — support both host and cross-compilation for iOS arm64
if("${CMAKE_OSX_ARCHITECTURES}" STREQUAL "arm64" OR
   "${CMAKE_HOST_SYSTEM_PROCESSOR}" STREQUAL "arm64" OR
   "${CMAKE_HOST_SYSTEM_PROCESSOR}" STREQUAL "aarch64")
	message(STATUS "Building for Apple Silicon / iOS (ARM64).")
	list(APPEND PCSX2_DEFS _M_ARM64=1)
	set(_M_ARM64 TRUE)
	set(_M_X86 FALSE)
	# Use armv8.4-a for iOS 18+ (A12+ chips support it)
	if(NOT CMAKE_SYSTEM_NAME STREQUAL "iOS")
...
elseif("${CMAKE_HOST_SYSTEM_PROCESSOR}" STREQUAL "x86_64" OR
	...
	message(STATUS "Proceeding with undetected architecture: ${CMAKE_HOST_SYSTEM_PROCESSOR}")
endif()
...
if(MSVC)
	...
	# -pipe is excluded from Swift in the main CMakeLists
